      ...
      <ContentSection
        ...
        content={
          <>
            ...
            <TextParagraph
              text="[Resources for learning Java](/programming/java-resources)"
              centered
              bold
              removeMargin
            />
            <LinkImage
              url="/programming/java-resources"
            ...
            <TextParagraph text="[Software Tools](/programming/software-tools)" centered bold removeMargin />
            <LinkImage
              url="/programming/software-tools"
            ...
            <TextParagraph text="[Programming the Robot](/programming/robot-coding-guide)" centered bold removeMargin />
            <LinkImage
              url="/programming/robot-coding-guide"
